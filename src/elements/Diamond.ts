...
class Diamond extends BaseElement {
  ...
  render() {
    ...
    this.board.ctx.lineTo(this.startX + this.width, this.startY + this.height / 2);
    this.board.ctx.lineTo(this.startX + this.width / 2, this.startY + this.height);
    this.board.ctx.lineTo(this.startX, this.startY + this.height / 2);
